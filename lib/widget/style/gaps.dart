...
import 'package:flutter_cnode/widget/style/colors.dart';
import 'package:flutter_cnode/widget/style/dimens.dart';
...
class Gaps {
  ...
  static Widget vGap8orderLine = const SizedBox(
    height: Dimens.gap_dp8,
    width: double.infinity,
    child: const DecoratedBox(decoration: BoxDecoration(color: Colours.order_line)),
  );

  static Widget vGap10orderLine = const SizedBox(
