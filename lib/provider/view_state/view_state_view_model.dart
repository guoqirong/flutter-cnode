...
import 'package:flutter_cnode/provider/exception.dart';
import 'package:flutter_cnode/provider/view_state/view_state.dart';


class ViewStateViewModel with ChangeNotifier {
  ...
  /*bool get reload => viewState == ViewState.reload;*/
